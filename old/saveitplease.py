...
def queryLibrariesUse(x,i):
        ...
        if 'library' not in lineTrack[current][lineTrack[current]['names'][-1]]['attributes']:
            lineTrack[current][lineTrack[current]['names'][-1]]['attributes']['library'] = []
        lineTrack[current][lineTrack[current]['names'][-1]]['attributes']['library'].append(name)
